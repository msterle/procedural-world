...
void UI::init(World* world, Camera* camera, GLFWwindow* window) {
	//UI::world = world;
	//UI::camera = camera;
	//UI::window = window;
...
void UI::setActive(UIBase* UIinstance) {
...
void UI::UIWalk::onKey(GLFWwindow* window, int key, int scancode, int action, int mods) {
...
void UI::UIWalk::onMouseButton(GLFWwindow* window, int button, int action, int mods) {
...
void UI::UIWalk::onCursorMove(GLFWwindow* window, double xpos, double ypos) {
...
void UI::UIWalk::onResize(GLFWwindow* window, int width, int height) {
